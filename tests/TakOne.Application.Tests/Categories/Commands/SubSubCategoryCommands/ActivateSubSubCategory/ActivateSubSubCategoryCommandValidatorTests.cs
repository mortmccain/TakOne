...
/// <summary>
/// Unit tests for <see cref="ActivateSubSubCategoryCommandValidator"/>.
///
/// COVERAGE APPROACH: the validator has three NotEmpty rules — CategoryId,
/// SubCategoryId, and SubSubCategoryId. We exercise the happy path plus
/// the empty-Guid failure cases for each of the three Guid properties.
/// </summary>
public class ActivateSubSubCategoryCommandValidatorTests
{
    // ── Helpers ─────────────────────────────────────────────────────────
    ...
    {
        // Arrange
        var validator = new ActivateSubSubCategoryCommandValidator();
